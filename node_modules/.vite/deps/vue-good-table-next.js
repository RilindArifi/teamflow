...
var _hoisted_5$6 = createBaseVNode(
  "span",
  {
    id: "change-page-hint",
    style: { "display": "none" }
...
function _sfc_render$6(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("div", _hoisted_1$6, [
    $props.infoFn ? (openBlock(), createElementBlock(
      "div",
      _hoisted_2$6,
      toDisplayString($props.infoFn($options.infoParams)),
      1
      /* TEXT */
    )) : $props.mode === "pages" ? (openBlock(), createElementBlock(
      "form",
      {
        key: 1,
      ...
      [
        createBaseVNode("label", {
          ...
          createBaseVNode(
            "span",
            null,
            toDisplayString($props.pageText),
            1
            /* TEXT */
          ),
          ...
          createBaseVNode(
            "span",
            null,
            toDisplayString($options.pageInfo),
            1
            /* TEXT */
          )
        ], 8, _hoisted_3$6),
      ...
      "div",
      _hoisted_6$6,
      toDisplayString($options.recordInfo),
      1
      /* TEXT */
    ))
  ]);
      ...
      createBaseVNode("form", null, [
        ...
        withDirectives(createBaseVNode("select", {
          ...
          (openBlock(true), createElementBlock(
            Fragment,
            null,
            renderList($data.rowsPerPageOptions, (option, idx) => {
...
var _hoisted_4$4 = createBaseVNode(
  "span",
  {
    "aria-hidden": "true",
    class: "input__icon"
...
var _hoisted_5$4 = createBaseVNode(
  "span",
  { class: "sr-only" },
  "Search",
  -1
...
function _sfc_render$4(_ctx, _cache, $props, $setup, $data, $options) {
  return $options.showControlBar ? (openBlock(), createElementBlock("div", _hoisted_1$4, [
    createBaseVNode("div", _hoisted_2$4, [
      $props.searchEnabled ? (openBlock(), createElementBlock(
        "form",
        {
          key: 0,
...
function _sfc_render$3(_ctx, _cache, $props, $setup, $data, $options) {
  return $options.hasFilterRow ? (openBlock(), createElementBlock("tr", _hoisted_1$3, [
    ...
    (openBlock(true), createElementBlock(
      Fragment,
      null,
      renderList($props.columns, (column, index2) => {
        return openBlock(), createElementBlock(
          Fragment,
          { key: index2 },
          [
            !column.hidden ? (openBlock(), createElementBlock(
              "th",
              {
                key: 0,
                  ...
                  $options.isFilterable(column) ? (openBlock(), createElementBlock("div", _hoisted_5$3, [
                    ...
                    $options.isDropdownArray(column) ? (openBlock(), createElementBlock("select", {
                      ...
                      createBaseVNode(
                        "option",
                        _hoisted_8$2,
                        toDisplayString($options.getPlaceholder(column)),
                        1
                        /* TEXT */
                      ),
                      (openBlock(true), createElementBlock(
                        Fragment,
                        null,
                        renderList(column.filterOptions.filterDropdownItems, (option, i) => {
                          return openBlock(), createElementBlock("option", {
                            key: i,
                            value: option
...
var _sfc_main$2 = {
  ...
  methods: {
    ...
    getColumnStyle(column, index2) {
      ...
      if (this.tableRef) {
        if (this.selectable) index2++;
        if (this.lineNumbers) index2++;
              ...
              !column.hidden ? (openBlock(), createElementBlock("th", {
                ...
                $options.isSortableColumn(column) ? (openBlock(), createElementBlock("button", {
                  ...
                  createBaseVNode(
                    "span",
                    _hoisted_7$2,
                    " Sort table by " + toDisplayString(column.label) + " in " + toDisplayString($options.getColumnSortLong(column)) + " order ",
                    1
                    /* TEXT */
                  )
  ...
  return openBlock(), createElementBlock("tr", null, [
    $props.headerRow.mode === "span" ? (openBlock(), createElementBlock("th", {
      ...
      createBaseVNode("span", {
        ...
        $props.collapsable ? (openBlock(), createElementBlock(
          "span",
          {
            key: 0,
        ...
        renderSlot(_ctx.$slots, "table-header-row", { row: $props.headerRow }, () => [
          ...
          }, null, 8, _hoisted_3$1)) : (openBlock(), createElementBlock(
            "span",
            _hoisted_4$1,
            toDisplayString($props.headerRow.label),
            1
            /* TEXT */
          ))
        ])
    ...
    (openBlock(true), createElementBlock(
      Fragment,
      null,
      renderList($props.columns, (column, i) => {
        return openBlock(), createElementBlock(
          Fragment,
          { key: i },
          [
            $props.headerRow.mode !== "span" && !column.hidden ? (openBlock(), createElementBlock("th", {
              ...
              $options.columnCollapsable(i) ? (openBlock(), createElementBlock(
                "span",
                {
                  key: 0,
                  class: normalizeClass(["triangle", { "expand": $props.headerRow.vgtIsExpanded }])
              ...
              renderSlot(_ctx.$slots, "table-header-row", {
                ...
                !column.html ? (openBlock(), createElementBlock(
                  "span",
                  _hoisted_9$1,
                  toDisplayString($props.collectFormatted($props.headerRow, column, true)),
                  1
                  /* TEXT */
                )) : createCommentVNode("v-if", true),
...
date.compare = function(x, y, column) {
  function cook(d) {
    if (column && column.dateInputFormat) {
      return parse(`${d}`, `${column.dateInputFormat}`, /* @__PURE__ */ new Date());
...
date.format = function(v, column) {
  ...
  const date2 = parse(v, column.dateInputFormat, /* @__PURE__ */ new Date());
  if (isValid(date2)) {
...
number.compare = function(x, y) {
  function cook(d) {
    if (d === void 0 || d === null) return -Infinity;
...
var _hoisted_18 = createBaseVNode(
  "div",
    ...
    [
      ...
      createBaseVNode(
        ...
        [
          ...
          $options.selectedRowCount && !_ctx.disableSelectInfo ? (openBlock(), createElementBlock(
            "div",
            {
              key: 1,
            ...
            [
              createTextVNode(
                toDisplayString($options.selectionInfo) + " ",
                1
                /* TEXT */
              ),
              createBaseVNode(
                ...
                toDisplayString(_ctx.clearSelectionText),
                1
                /* TEXT */
              ),
          ...
          createBaseVNode("div", _hoisted_4, [
            $props.fixedHeader ? (openBlock(), createElementBlock(
              "table",
              {
                key: 0,
                id: "vgt-table",
                  ...
                  "table-column": withCtx((slotProps) => [
                    renderSlot(_ctx.$slots, "table-column", {
                      ...
                      createBaseVNode(
                        "span",
                        null,
                        toDisplayString(slotProps.column.label),
                        1
                        /* TEXT */
                      )
                    ])
              ...
              createBaseVNode(
                ...
                [
                  ...
                  (openBlock(true), createElementBlock(
                    Fragment,
                    null,
                    renderList($options.paginated, (headerRow, hIndex) => {
                      return openBlock(), createElementBlock("tbody", { key: hIndex }, [
                        ...
                        (openBlock(true), createElementBlock(
                          Fragment,
                          null,
                          renderList(headerRow.children, (row, index2) => {
                            return openBlock(), createElementBlock(
                              Fragment,
                              null,
                              [
                                ($props.groupOptions.collapsable ? headerRow.vgtIsExpanded : true) ? (openBlock(), createElementBlock("tr", {
                                  ...
                                  $props.lineNumbers ? (openBlock(), createElementBlock(
                                    "th",
                                    _hoisted_8,
                                    toDisplayString($options.getCurrentIndex(row.originalIndex)),
                                    1
                                    /* TEXT */
                                  )) : createCommentVNode("v-if", true),
                                          ...
                                          !column.hidden && column.field ? (openBlock(), createElementBlock("td", {
                                            ...
                                            renderSlot(_ctx.$slots, "table-row", {
                                              ...
                                              !column.html ? (openBlock(), createElementBlock(
                                                "span",
                                                _hoisted_12,
                                                toDisplayString($options.collectFormatted(row, column)),
                                                1
                                                /* TEXT */
                                ...
                                _ctx.expandedRowIndex === index2 ? (openBlock(), createElementBlock(
                                  "tr",
                                  {
...
vue-good-table-next/dist/vue-good-table.esm.js:
  (*!
