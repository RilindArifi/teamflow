import {
  DayTable
} from "./chunk-K5Z36GV3.js";
import "./chunk-5X4FYJD5.js";
import {
  BaseComponent,
  BgEvent,
  ContentContainer,
...
function TimeColsAxisCell(props) {
  ...
  return h(ViewContextType.Consumer, null, (context) => {
    ...
    }, renderProps, generatorName: "slotLabelContent", generator: options.slotLabelContent || renderInnerContent, classNameGenerator: options.slotLabelClassNames, didMount: options.slotLabelDidMount, willUnmount: options.slotLabelWillUnmount }, (InnerContent) => h(
      "div",
    ...
    this.renderHeadAxis = (rowKey, frameHeight = "") => {
      ...
      if (options.weekNumbers && rowKey === "day") {
        return h(WeekNumberContainer, { elTag: "th", elClasses: [
          ...
          "aria-hidden": true
        }, date: range.start, defaultFormat: DEFAULT_WEEK_NUM_FORMAT }, (InnerContent) => h(
          "div",
          { className: [
