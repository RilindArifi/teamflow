    ...
    var makeBuiltIn = module.exports = function(value, name, options) {
      ...
      try {
        if (options && hasOwn(options, "constructor") && options.constructor) {
          if (DESCRIPTORS2) defineProperty2(value, "prototype", { writable: false });
...
var require_get_iterator_method = __commonJS({
  "node_modules/core-js/internals/get-iterator-method.js"(exports, module) {
    ...
    var ITERATOR2 = wellKnownSymbol3("iterator");
    module.exports = function(it) {
      if (it != void 0) return getMethod3(it, ITERATOR2) || getMethod3(it, "@@iterator") || Iterators[classof(it)];
    };
  }
});
...
// node_modules/simplebar-vue3/dist/simplebar-vue3.mjs
var s = Symbol("simplebar");
function E(t) {
  provide(s, t);
}
function C() {
...
var H = defineComponent({
  ...
  setup(t, { emit: n, slots: u, expose: d }) {
    const e = ref(null), l = ref(null);
    d(e), E(e);
    const a = (p) => {
      if (!l.value || p === "activated" && e.value)
        return;
      const o = new simplebar_esm_default(l.value, t.options);
      e.value = o;
    ...
    return onMounted(() => a("mounted")), onActivated(() => a("activated")), onDeactivated(() => {
      e.value = null;
    }), () => h(
      t.tag,
      {
      ...
      renderSlot(u, "default", { instance: e.value })
    );
  }
});
export {
...
//# sourceMappingURL=simplebar-vue3.js.map
