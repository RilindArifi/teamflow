import {
  require_vue
} from "./chunk-4EGC5NL2.js";
import "./chunk-2QF5QTCF.js";
import {
  __commonJS,
  __esm,
  __export,
...
var cleave_esm_exports = {};
__export(cleave_esm_exports, {
  default: () => cleave_esm_default
});
var commonjsGlobal, NumeralFormatter, NumeralFormatter_1, DateFormatter, DateFormatter_1, TimeFormatter, TimeFormatter_1, PhoneFormatter, PhoneFormatter_1, CreditCardDetector, CreditCardDetector_1, Util, Util_1, DefaultProperties, DefaultProperties_1, Cleave, Cleave_1, cleave_esm_default;
var init_cleave_esm = __esm({
  "node_modules/cleave.js/dist/cleave-esm.js"() {
    commonjsGlobal = typeof window !== "undefined" ? window : typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : {};
    NumeralFormatter = function(numeralDecimalMark, numeralIntegerScale, numeralDecimalScale, numeralThousandsGroupStyle, numeralPositiveOnly, stripLeadingZeroes, prefix, signBeforePrefix, tailPrefix, delimiter) {
      var owner = this;
    ...
    TimeFormatter = function(timePattern, timeFormat) {
      var owner = this;
      owner.time = [];
      owner.blocks = [];
    ...
    TimeFormatter_1 = TimeFormatter;
    PhoneFormatter = function(formatter, delimiter) {
      var owner = this;
      owner.delimiter = delimiter || delimiter === "" ? delimiter : " ";
      owner.delimiterRE = delimiter ? new RegExp("\\" + delimiter, "g") : "";
    ...
    PhoneFormatter_1 = PhoneFormatter;
    CreditCardDetector = {
      blocks: {
        uatp: [4, 5, 6],
        amex: [4, 6, 5],
    ...
    CreditCardDetector_1 = CreditCardDetector;
    Util = {
      noop: function() {
      },
    ...
    DefaultProperties_1 = DefaultProperties;
    Cleave = function(element, opts) {
      var owner = this;
    ...
    Cleave_1 = Cleave;
    cleave_esm_default = Cleave_1;
  }
});

// node_modules/vue-cleave-component/dist/vue-cleave.min.js
var require_vue_cleave_min = __commonJS({
  "node_modules/vue-cleave-component/dist/vue-cleave.min.js"(exports, module) {
    !function(e, t) {
      "object" == typeof exports && "object" == typeof module ? module.exports = t((init_cleave_esm(), __toCommonJS(cleave_esm_exports)), require_vue()) : "function" == typeof define && define.amd ? define("VueCleave", ["cleave.js", "vue"], t) : "object" == typeof exports ? exports.VueCleave = t((init_cleave_esm(), __toCommonJS(cleave_esm_exports)), require_vue()) : e.VueCleave = t(e.Cleave, e.Vue);
    }(self, function(e, t) {
      return (() => {
        "use strict";
        var a = { 52: (t2) => {
        ...
        function o(e2) {
          ...
          var n2 = l[e2] = { exports: {} };
          return a[e2](n2, n2.exports, o), n2.exports;
        }
        o.n = (e2) => {
          var t2 = e2 && e2.__esModule ? () => e2.default : () => e2;
          return o.d(t2, { a: t2 }), t2;
        }, o.d = (e2, t2) => {
          for (var a2 in t2) o.o(t2, a2) && !o.o(e2, a2) && Object.defineProperty(e2, a2, { enumerable: true, get: t2[a2] });
        }, o.o = (e2, t2) => Object.prototype.hasOwnProperty.call(e2, t2);
        var n = {};
        return (() => {
          o.d(n, { default: () => r });
          var e2 = o(52), t2 = o.n(e2), a2 = o(982);
          const l2 = { name: "cleave", render() {
            return (0, a2.h)("input", { type: "text", value: this.cleave ? this.cleave.properties.result : this.modelValue, onBlur: this.onBlur, ref: "root" });
          }, props: { modelValue: { default: null, required: true, validator: (e3) => null === e3 || "string" == typeof e3 || e3 instanceof String || "number" == typeof e3 }, options: { type: Object, default: () => ({}) }, raw: { type: Boolean, default: true } }, data: () => ({ cleave: null, onValueChangedFn: null }), mounted() {
            this.cleave || (this.cleave = new (t2())(this.$refs.root, this.getOptions(this.options)));
          }, methods: { getOptions(e3) {
            return this.onValueChangedFn = e3.onValueChanged, Object.assign({}, e3, { onValueChanged: this.onValueChanged });
          }, onValueChanged(e3) {
            let t3 = this.raw ? e3.target.rawValue : e3.target.value;
            this.$emit("update:modelValue", t3), "function" == typeof this.onValueChangedFn && this.onValueChangedFn.call(this, e3);
          }, onBlur(e3) {
            this.$emit("blur", this.modelValue);
          } }, watch: { options: { deep: true, handler(e3) {
            this.cleave.destroy(), this.cleave = new (t2())(this.$refs.root, this.getOptions(e3)), this.cleave.setRawValue(this.modelValue);
          } }, modelValue(e3) {
            this.cleave && (this.raw && e3 === this.cleave.getRawValue() || (this.raw || e3 !== this.$refs.root.value) && this.cleave.setRawValue(e3));
          } }, beforeUnmount() {
            this.cleave && (this.cleave.destroy(), this.cleave = null, this.onValueChangedFn = null);
          } };
          l2.install = (e3, t3) => {
            let a3 = "cleave";
            "string" == typeof t3 && (a3 = t3), e3.component(a3, l2);
          };
          const r = l2;
        })(), n = n.default;
      })();
...
export default require_vue_cleave_min();
//# sourceMappingURL=vue-cleave-component.js.map
