        ...
        <div class="md:flex items-end md:space-x-6 rtl:space-x-reverse">
          ...
          <div class="flex-1">
            ...
            <div class="text-sm font-light text-slate-600 dark:text-slate-400">
              {{ store.user.job_title ?? 'Front End Developer' }}
            </div>
          </div>
        </div>
      </div>
            ...
            <li class="flex space-x-3 rtl:space-x-reverse">
              ...
              <div class="flex-1">
                ...
                <a
                    ...
                    class="text-base text-slate-600 dark:text-slate-50"
                >
                  {{ store.user.phone_number ?? '+1-202-555-0151' }}
                </a>
              </div>
            </li>
            <!-- end single list -->
            <li class="flex space-x-3 rtl:space-x-reverse">
              ...
              <div class="flex-1">
                ...
                <div class="text-base text-slate-600 dark:text-slate-50">
                  {{ store.user.phone_number ?? 'Home# 320/N, Road# 71/B, Mohakhali, Dhaka-1207, Bangladesh' }}
                </div>
              </div>
            </li>
            <!-- end single list -->
